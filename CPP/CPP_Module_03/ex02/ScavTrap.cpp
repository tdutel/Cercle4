...
/*   Updated: 2023/12/06 15:09:56 by tdutel           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap(std::string name)
{
	...
	this->_energyPoints = 50;
	this->_attackDamage = 20;
	std::cout << "a wild legendary " << name << " appears ! (ScavTrap constructor called)" << std::endl;
}

ScavTrap::ScavTrap(const ScavTrap &clapTrap)
{
	*this = clapTrap;
	std::cout << "A wild Legendary copy appears ! (ScavTrap constructor called)" << std::endl;
}
